...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (Schema::getConnection()->getDriverName() === 'sqlite') {
            $this->rebuildSqliteTransactionsTable(['deposit', 'withdraw', 'transfer', 'receive', 'deduction', 'recharge']);
            return;
        }

        DB::statement("ALTER TABLE transactions MODIFY COLUMN type ENUM('deposit', 'withdraw', 'transfer', 'receive', 'deduction', 'recharge')");
    }
