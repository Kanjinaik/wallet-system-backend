-- =========================================================
-- WALLET SYSTEM DATABASE DOCUMENTATION
-- =========================================================
-- Purpose:
-- Full database schema reference for manager review/sharing.
-- Source:
-- Generated from the current Laravel migration structure.
-- Note:
-- This is documentation/reference SQL and does not change app flow.
...
CREATE TABLE "users" (
  ...
  "phone" varchar,
  "role" varchar check ("role" in ('user', 'admin', 'master_distributor', 'distributor', 'retailer')) not null default 'user',
  ...
  "bank_name" varchar,
  "kyc_document_path" varchar,
  "kyc_status" varchar not null default ('pending'),
  "withdraw_otp_code" varchar,
  ...
  "kyc_id_number" varchar,
  "kyc_photo_path" varchar,
  "address_proof_front_path" varchar,
  "address_proof_back_path" varchar,
  "kyc_document_type" varchar,
  "kyc_selfie_path" varchar,
  "kyc_liveness_verified" tinyint(1) not null default '0',
  "plain_password" varchar,
  "pan_number" varchar,
  "pan_proof_front_path" varchar,
  "pan_proof_back_path" varchar
);
...
CREATE TABLE "wallets" (
  ...
  "name" varchar not null,
  "type" varchar check ("type" in ('main', 'sub')) not null default 'main',
...
CREATE TABLE "transactions" (
  ...
  "type" varchar check ("type" in ('deposit', 'withdraw', 'transfer', 'receive')) not null,
...
CREATE TABLE "scheduled_transfers" (
  ...
  "amount" numeric not null,
  "description" text,
  "frequency" varchar check ("frequency" in ('daily', 'weekly', 'monthly', 'yearly', 'once')) not null,
...
CREATE TABLE "wallet_limits" (
  "id" integer primary key autoincrement not null,
  "user_id" integer not null,
  "limit_type" varchar check ("limit_type" in ('daily', 'monthly', 'per_transaction')) not null,
...
CREATE TABLE "withdraw_requests" (
  ...
  "status" varchar check ("status" in ('pending', 'approved', 'rejected', 'processed')) not null default 'pending',
  "remarks" text,
  "reviewed_by" integer,
...
CREATE TABLE "commission_configs" (
  "id" integer primary key autoincrement not null,
  "name" varchar not null,
  "user_role" varchar check ("user_role" in ('admin', 'distributor', 'retailer', 'user')) not null,
  "admin_commission" numeric not null default '0',
  "distributor_commission" numeric not null default '0',
  "is_active" tinyint(1) not null default '1',
  "created_at" datetime,
  "updated_at" datetime
);
...
CREATE TABLE "commission_transactions" (
  ...
  "user_id" integer not null,
  "wallet_id" integer not null,
  "commission_type" varchar check ("commission_type" in ('admin', 'distributor')) not null,
...
CREATE TABLE "wallet_adjustments" (
  ...
  "user_id" integer not null,
  "wallet_id" integer not null,
  "type" varchar check ("type" in ('add', 'deduct', 'force_settlement')) not null,
  "amount" numeric not null,
  "reference" varchar not null,
  "remarks" text,
  "created_at" datetime,
...
CREATE TABLE "support_threads" (
  ...
  "created_at" datetime,
  "updated_at" datetime,
  "subject" varchar not null default 'Support Ticket',
  "category" varchar,
  foreign key("user_id") references "users"("id") on delete cascade,
...
CREATE TABLE "support_messages" (
  "id" integer primary key autoincrement not null,
  "support_thread_id" integer not null,
  ...
  "created_at" datetime,
  "updated_at" datetime,
  foreign key("support_thread_id") references "support_threads"("id") on delete cascade
);
...
CREATE TABLE "users_commission" (
  ...
  "withdrawal_commission" numeric not null default '0',
  "available_commission" numeric not null default '0',
  "created_at" datetime,
  "updated_at" datetime,
  foreign key("user_id") references "users"("id") on delete cascade
);
